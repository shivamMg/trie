	...
	testCases := []struct {
	...
	}{
		{
			...
			expectedOps: []*EditOp{
				...
				{Type: EditOpTypeNone, KeyPart: "i"},
				{Type: EditOpTypeNone, KeyPart: "t"},
				{Type: EditOpTypeNone, KeyPart: "t"},
				{Type: EditOpTypeReplace, KeyPart: "i", ReplaceWith: "e"},
				{Type: EditOpTypeNone, KeyPart: "n"},
		...
		},
		{
			...
			expectedOps: []*EditOp{
				{Type: EditOpTypeNone, KeyPart: "S"},
				{Type: EditOpTypeInsert, KeyPart: "a"},
				{Type: EditOpTypeInsert, KeyPart: "t"},
				{Type: EditOpTypeNone, KeyPart: "u"},
				{Type: EditOpTypeReplace, KeyPart: "n", ReplaceWith: "r"},
				{Type: EditOpTypeNone, KeyPart: "d"},
				{Type: EditOpTypeNone, KeyPart: "a"},
				{Type: EditOpTypeNone, KeyPart: "y"},
			},
		},
	}
